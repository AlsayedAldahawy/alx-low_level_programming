...
random_sign1=$(($((RANDOM - RANDOM)) % 10))
if [ $random_sign1 -le 0 ]; then
    random_sign1=-1
else
    random_sign1=1
fi

random_sign2=$(($((RANDOM - RANDOM)) % 10))
if [ $random_sign2 -le 0 ]; then
    random_sign2=-1
else
    random_sign2=1
fi
...
if [ "$(./101-mul "$(./101-mul $BIG1 $random_sign1)" "$(./101-mul $BIG2 $random_sign2)")" != "$(./101-mul $MULBIG $((random_sign1 * random_sign2)))" ]; then
